...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add_customer'])) {
    ...
    mysqli_query($conn, "INSERT INTO customers (full_name, phone, email, address, city, `password`)
                         VALUES ('$name','$phone','$email','$address','$city','$default_pass')");
...
$customers = mysqli_query($conn, "SELECT * FROM customers ORDER BY id ASC");
...
<head>
  ...
  <style>
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    table td { padding:12px 12px; border-bottom:1px solid rgba(255,255,255,0.04); color:rgba(255,255,255,0.75); transition:background 0.2s; }
...
<div class="main">
  ...
  <?php if (isset($_GET['success'])): ?>
    <div class="success-msg">
      <?php echo $_GET['success'] == 'added' ? '✅ Customer added! Default password: rskf1234' : '🗑️ Customer deleted.'; ?>
    </div>
  <?php endif; ?>

  <div class="info-msg">
    ℹ️ Customers added by admin get default password: <strong>rskf1234</strong> — They can login at <strong>customer_login.php</strong> using their email.
  </div>
      ...
      <div class="form-grid">
        <div>
          ...
          <div class="input-wrap">
            ...
            <input type="text" name="full_name" placeholder="Customer name" required>
          </div>
        </div>
        <div>
          <label>Phone</label>
        ...
        <div style="grid-column:span 2">
          ...
          <div class="input-wrap">
            <span class="icon">🏠</span>
            <textarea name="address" placeholder="Street, Area"></textarea>
          </div>
        </div>
      </div>
  ...
  <div class="table-box">
    <h3>All Customers <span class="total-badge"><?php echo $total; ?> total</span></h3>
    <table>
      <tr>
        <th>#</th><th>Name</th><th>Phone</th>
        <th>Email</th><th>City</th><th>Login</th><th>Action</th>
      </tr>
      <?php
      $i = 1;
      if (mysqli_num_rows($customers) == 0) {
          echo "<tr><td colspan='7' class='empty'>No customers found</td></tr>";
      }
          ...
          echo "<tr>
            ...
            <td>
              <a href='customers.php?delete={$row['id']}'
                 class='btn-delete'
                 onclick='return confirm(\"Delete this customer?\")'>🗑️ Delete</a>
            </td>
          </tr>";
          $i++;
      }
