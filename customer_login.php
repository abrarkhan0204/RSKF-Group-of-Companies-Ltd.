...
<head>
  <meta charset="UTF-8">
  <title>RSKF — Customer Login</title>
  <style>
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    .form-group input:focus { outline:none; border-color:#c0392b; background:rgba(255,255,255,0.08); box-shadow:0 0 0 3px rgba(192,57,43,0.15); }
...
<div class="login-container">
  <div class="left-panel">
    ...
    <div class="role-badge">
      ...
      <p>View products, place orders and track your deliveries</p>
    </div>
  ...
  <div class="right-panel">
    ...
    <div class="links">
      Don't have an account? <a href="register.php?role=customer">Register here</a>
